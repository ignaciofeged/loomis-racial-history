...
timeline_data1<-read_xlsx("https://raw.github.com/ignaciofeged/loomis-racial-history/blob/heroku/Timeline%20Data4-1.xlsx")
...
timeline_data2<-read_xlsx("https://raw.github.com/ignaciofeged/loomis-racial-history/blob/heroku/Timeline%20Data4-2.xlsx")
